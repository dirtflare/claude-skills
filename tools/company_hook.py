...
ROUTING = [
    ("marketing", ["発信", "note", "SNS", "X投稿", "ポスト", "訴求", "LP", "コピー", "集客",
                   "マーケ", "ブログ", "記事", "動画", "サムネ", "デザイン", "landing"]),
    ("research", ["調べ", "調査", "リサーチ", "競合", "トレンド", "裏取り", "出典", "検証",
                  "比較", "ドキュメント", "仕様", "research", "search"]),
    ("finance", ["売上", "経費", "単価", "値付け", "価格", "料金", "請求", "税", "見積", "コスト",
                 "収支", "利益", "予算"]),
    ("sales", ["商談", "DM", "問い合わせ", "見込み", "顧客", "契約", "提案書", "営業"]),
]
